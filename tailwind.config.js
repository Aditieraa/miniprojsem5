  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        'moderate': '0 4px 12px rgba(0, 0, 0, 0.08), 0 2px 4px rgba(0, 0, 0, 0.04)',
        'prominent': '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)',
        'glow': '0 0 20px rgba(0, 77, 153, 0.15)',
        'glow-accent': '0 0 25px rgba(255, 193, 7, 0.2)',
      },
      animation: {
      ...
      backgroundImage: {
        ...
        'hero-gradient': "linear-gradient(135deg, rgba(0,77,153,0.9) 0%, rgba(0,153,204,0.8) 100%)",
        'job-card-gradient': "linear-gradient(135deg, #FFFFFF 0%, #F8F9FA 100%)",
      },
      backgroundSize: {
        'grid-sm': '20px 20px',
        'grid-md': '40px 40px',
